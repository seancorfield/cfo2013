<html>
<head>
<title>ORM, NoSQL, and Vietnam - By Tag</title>
</head>
<body>
<cfoutput>
  <h1>Posts for Tag #url.tag#</h1>

  <cfset posts = request.mongo.getDBCollection("posts") />
  <cfset entries = posts.find( criteria = { "published" : true, "tags" : url.tag }, sort = { "posted" : -1 }, limit = 15 ) />
